...
RETURNS TABLE(
    ...
    "soldUnits" BIGINT,
    "soldTotalPrices" DOUBLE PRECISION, --or DOUBLE PRECISION
    "lastPurchaseAt" TEXT
) AS $$
BEGIN
    RETURN QUERY
...
--         CASE
--         WHEN COALESCE(s.TotalSales, 0) = 0
--             THEN 0::DOUBLE PRECISION ELSE ROUND(COALESCE(s.TotalSales, 0)::numeric, 2)::double precision
--         END

--             AS soldTotalPrices,--or DOUBLE PRECISION
        COALESCE(s.TotalSales, 0):: DOUBLE PRECISION AS soldTotalPrices,
