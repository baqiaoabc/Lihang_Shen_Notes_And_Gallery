...
def make_withdraw(balance, password):
    ...
    "*** YOUR CODE HERE ***"
    incorrect_pass = []
    def protected(amount,input_password):
        nonlocal incorrect_pass,balance,password
        if len(incorrect_pass) >= 3:
            return f"Too many incorrect attempts. Attempts: {incorrect_pass}"
        if input_password == password:
            ...
            incorrect_pass.append(input_password)
